                  ...
                  <Link href={item.href} key={item.slug} prefetch={true}>
                    ...
                    >
                      <Image
                        ...
                        sizes="40px"
                        placeholder="blur"
                        blurDataURL="data:image/jpeg;base64,"
                      />
